...
def _migration_20(con: sqlite3.Connection) -> None:
    con.executescript(
        """
        create temp table _migration_20_suggestions as
            select * from suggestions;
        create temp table _migration_20_suggestion_channels as
            select * from suggestion_channels;
        create temp table _migration_20_suggestion_links as
            select * from suggestion_links;
        create temp table _migration_20_suggestion_activity as
            select * from suggestion_activity;
        create temp table _migration_20_suggestion_file_reviews as
        ...
        insert into suggestions
            select * from _migration_20_suggestions;
        ...
        insert into suggestion_channels
            select * from _migration_20_suggestion_channels;
        ...
        insert into suggestion_links
            select * from _migration_20_suggestion_links;
        ...
        insert into suggestion_activity
            select * from _migration_20_suggestion_activity;
        ...
        insert into suggestion_file_reviews
            select * from _migration_20_suggestion_file_reviews;

        drop table _migration_20_suggestion_file_reviews;
        drop table _migration_20_suggestion_activity;
        drop table _migration_20_suggestion_links;
        drop table _migration_20_suggestion_channels;
        drop table _migration_20_suggestions;
        """
    )
